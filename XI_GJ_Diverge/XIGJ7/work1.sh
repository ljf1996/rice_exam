...
perl dissect_rice_bin7.pl $sample/sample.bin_NAF >$sample/${sample}.bin_NAF
## plot
...
Rscript draw_bin.rice7.R /mnt/project/Zayou_center/Denovo_project/project/09.indica_japonica_mix/3KRG-HAP-master/data/chr.len $sample/${sample}.bin_NAF $sample/$sample
